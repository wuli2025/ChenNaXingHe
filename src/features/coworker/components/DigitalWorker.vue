  ...
  >
    ...
    >
      ...
      <g class="body-sway">
        <path
          class="robe"
          d="M42 86 Q44 58 60 56 Q76 58 78 86 Z"
        />
        <!-- 衣领交叠 -->
        <path
          class="collar"
          d="M54 60 L60 70 L66 60"
        />
        <!-- 头 -->
        <circle
          class="face"
        ...
        <path
          class="hair"
          d="M49 44 Q50 33 60 32 Q70 33 71 44 Q66 39 60 39 Q54 39 49 44 Z"
        />
        <circle
          class="bun"
          cx="60"
