...
陈娜星河（ChenNaXingHe）是一个**跑在你自己电脑上**的跨境电商 AI 工作台。它把 Claude Code 的对话能力、可检索的本地知识库、可插拔的技能系统、多家 API 供应商的一键切换，以及外贸 OS 全链路业务模块，收进同一个墨蓝水墨风的桌面应用里。
...
| ⑤ 外贸 OS | 全链路外贸业务原生模块（12 模块 + 人工审核看板），直连 Claude Code |
